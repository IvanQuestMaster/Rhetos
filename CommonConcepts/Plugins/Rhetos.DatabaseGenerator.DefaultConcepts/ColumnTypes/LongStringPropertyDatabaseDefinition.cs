...
namespace Rhetos.DatabaseGenerator.DefaultConcepts
{
    ...
    public class LongStringPropertyDatabaseDefinition : IConceptDatabaseDefinition
    {
        ...
        public LongStringPropertyDatabaseDefinition(ConceptMetadata conceptMetadata, ISqlUtility sqlUtility, ISqlResourceProvider sql)
        {
        ...
        public string CreateDatabaseStructure(IConceptInfo conceptInfo)
        {
            ...
            PropertyDatabaseDefinition.RegisterColumnMetadata(_conceptMetadata, info, _sqlUtility.Identifier(info.Name), _sql.Get("LongStringPropertyDatabaseDefinition_DataType"));
