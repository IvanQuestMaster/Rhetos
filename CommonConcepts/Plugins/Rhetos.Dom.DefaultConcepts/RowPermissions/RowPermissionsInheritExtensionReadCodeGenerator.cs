...
namespace Rhetos.Dom.DefaultConcepts
{
    ...
    [ExportMetadata(MefProvider.Implements, typeof(RowPermissionsInheritExtensionReadInfo))]
    public class RowPermissionsInheritExtensionReadCodeGenerator : IConceptCodeGenerator
    {
