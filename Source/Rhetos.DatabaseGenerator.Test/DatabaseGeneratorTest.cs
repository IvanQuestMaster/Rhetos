...
namespace Rhetos.DatabaseGenerator.Test
{
    ...
    public class DatabaseGeneratorTest
    {
        ...
        class MockDslModel : IDslModel
        {
            ...
            public IDslSubset<IConceptInfo> Concepts { get { return new DslSubset<IConceptInfo>(_conceptInfos); } }
            public IConceptInfo FindByKey(string conceptKey) { throw new NotImplementedException(); }
            public IDslSubset<IConceptInfo> FindByType(Type conceptType) { throw new NotImplementedException(); }
