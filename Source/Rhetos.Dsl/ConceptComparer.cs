...
{
    public static class ConceptsComparer
    {
        public static DiffResult Diff(this IEnumerable<IConceptInfo> oldConcepts, IEnumerable<IConceptInfo> newConcepts, bool ignoreCodeSnippets = false)
        {
            ...
            while (true)
            {
                ...
                if (keyDiff == 0)
                {
                    if (!SameValue(oldEnum.Current, newEnum.Current, ignoreCodeSnippets))
                    {
        ...
        private static bool SameValue(IConceptInfo concept1, IConceptInfo concept2, bool ignoreCodeSnippets)
        {
            ...
            {
                if (property.IsCodeSnippet && ignoreCodeSnippets)
                    continue;
