...
namespace Rhetos.Utilities
{
    public class GeneratedFilesCache
    {
        ...
        public void MoveGeneratedFilesToCache()
        {
            ...
            var generatedFiles = _filesUtility.SafeGetFiles(_paths.GeneratedFolder, "*", SearchOption.AllDirectories)
            ...
            foreach (string moveGroup in succesfullyGeneratedGroups)
                foreach (string moveFile in generatedFiles[moveGroup])
                    _syncer.AddFile(moveFile, Path.Combine(_paths.GeneratedFilesCacheFolder, moveGroup));
        ...
        {
            return _filesUtility.SafeGetFiles(_paths.GeneratedFilesCacheFolder, "*", SearchOption.AllDirectories)
