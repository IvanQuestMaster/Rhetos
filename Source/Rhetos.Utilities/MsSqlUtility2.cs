...
namespace Rhetos.Utilities
{
    public class MsSqlUtility2 : ISqlUtility
    {
        ...
        private SqlVersion GetSqlVersion(DbConnection connection)
        {
        ...
        private ServerType GetServerType(DbConnection connection)
        {
        ...
        private string GetVersionHint(SqlVersion version, ServerType serverType)
        {
        ...
        public string QueryForManifestToken(DbConnection conn)
        {
